...
// Newline
// 1st for loop: fill rendering screen with bg_color
// 2nd for loop: render buffer_ line by line
// memcpy: copy row + 1 line to row
// memset: fill bottom line with null
